...
export const getLocaleData = locale => () => new Promise((resolve) => {
...
export const getLocaleTranslation = locale => (dispatch, getState, { localeApi }) => {
  dispatch(localeRequest());

  return axios.get(`${localeApi}/${locale}`)
    .then((res) => {
